...
const Header = () => {
  return (
    <div className="mt-4 flex items-center md:justify-end md:me-4">
      <svg
        className="text-[40px] mr-4"
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        viewBox="0 0 512 512"
      ...
      <h1 className="font-semibold text-xl text-gray-600">Dragan Restaurant</h1>
    </div>
  );
};
